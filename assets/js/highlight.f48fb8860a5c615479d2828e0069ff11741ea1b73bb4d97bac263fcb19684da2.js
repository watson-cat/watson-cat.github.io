...
;hljs.registerLanguage("dart",e)})();/*! `properties` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("properties",e)})();/*! `pgsql` grammar compiled for Highlight.js 11.6.0 */
(()=>{var E=(()=>{"use strict";return E=>{
...
;hljs.registerLanguage("typescript",e)})();/*! `nginx` grammar compiled for Highlight.js 11.6.0 */
...
illegal:"[^\\s\\}\\{]"}}})();hljs.registerLanguage("nginx",e)})();/*! `php-template` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("php-template",n)})();/*! `node-repl` grammar compiled for Highlight.js 11.6.0 */
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})();hljs.registerLanguage("node-repl",a)})();/*! `makefile` grammar compiled for Highlight.js 11.6.0 */
